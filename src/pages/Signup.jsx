    ...
    <div className="max-w-md mx-auto px-4 py-12 md:py-20">
      ...
      {step === "details" ? (
        <form onSubmit={handleSendOtp} className="panel p-6 flex flex-col gap-4">
          ...
          <div className="flex gap-2 items-start text-xs text-slate-500"><ShieldCheck size={15} className="text-cyan-400 mt-0.5 shrink-0" /><span>Your email must be verified before you can access tournament features.</span></div>
